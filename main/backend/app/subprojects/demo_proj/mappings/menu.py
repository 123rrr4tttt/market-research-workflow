...
MENU_CONFIG = {
    "items": [
        ...
        {"key": "policy_graph", "label": "政策图谱", "path": "/graph.html?type=policy", "order": 40, "visible": True},
        {"key": "social_graph", "label": "社媒图谱", "path": "/graph.html?type=social", "order": 50, "visible": True},

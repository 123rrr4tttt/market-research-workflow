...
def payload_value_ref(
    ...
    *,
    ...
    return ValueRef(
        value_id=value_id,
        project_key=project_key,
        object_type=c2_1.SOURCE_LIBRARY_C2_1_PAYLOAD_TYPE,
...
def build_source_library_c2_1_program(
    *,
    ...
    root = atom_node(
        operation,
        input_type=c2_1.SOURCE_LIBRARY_C2_1_PAYLOAD_TYPE,
        output_type=c2_1.SOURCE_LIBRARY_C2_1_RESULT_TYPE,
    )
    metadata = freeze_json_object(
        {
            "schema": "mrw.successor.source-library.c2-1.program-metadata.v1",
            "operation_kind": c2_1.SOURCE_LIBRARY_C2_1_KIND,
            ...
            "canonical_owner": c2_1.SOURCE_LIBRARY_C2_1_OWNER,
        }
    )
    return ProgramSpec(
        program_id=program_id,
...
def compile_source_library_c2_1_program(
    program: ProgramSpec,
    catalog: OperationContractCatalogSnapshot,
    *,

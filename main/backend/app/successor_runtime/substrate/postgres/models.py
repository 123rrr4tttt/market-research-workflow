"""SQLAlchemy Core schema contract for the P0-B durable substrate.

This module declares tables only.  Runtime code must never call ``create_all``;
the matching Alembic revision is the sole production schema authority.
"""
...
runtime_projection_offsets = sa.Table(
    ...
    sa.Column("source_ref", REF, nullable=False),
    sa.Column("source_incarnation", IDENTITY, nullable=False),
    sa.Column("projection_generation", sa.BigInteger, nullable=False, server_default="0"),
    ...
    sa.UniqueConstraint(
        ...
        "source_ref",
        "source_incarnation",
        name="uq_projection_owner_source",
    ),
    sa.CheckConstraint(
...
runtime_run_projections = sa.Table(
    "runtime_run_projections",
    PUBLIC_METADATA,
    sa.Column("project_key", PROJECT_KEY, primary_key=True),
    sa.Column("projector_id", IDENTITY, primary_key=True),
    sa.Column("projector_version", sa.String(64), primary_key=True),
    sa.Column("source_ref", REF, primary_key=True),
    sa.Column("source_incarnation", IDENTITY, primary_key=True),
    sa.Column("run_id", IDENTITY, primary_key=True),
    sa.Column("projection_generation", sa.BigInteger, nullable=False),
    sa.Column("source_revision", sa.BigInteger, nullable=False),
    sa.Column("source_digest", DIGEST, nullable=False),
    sa.Column("state_json", JSONB, nullable=False),
    sa.Column("projection_digest", DIGEST, nullable=False),
    sa.Column("revision", sa.BigInteger, nullable=False, server_default="0"),
    _created(),
    _updated(),
    sa.CheckConstraint(

"""Deterministically generate the normalized P4 C8 evidence fragment.

Root schema: ``mrw.functorial_successor.p4_fragment.v1``.  The generator binds
the C8.1 typed read-handle/demand-read atom, C8.2 ordered writing composition
and staged artifacts, C8.3 report admission/delivery interface contracts, and
C8.4 declared-loss graph projection, all ahead of time and unadopted.  It
never calls admission, export, providers, credentials, network or store code.

Run from ``main/backend``:

    python3.11 scripts/generate_successor_p4_c8_fragment.py
...
FRAGMENT_PATH = EVIDENCE_ROOT / "p4-fragments/C8.json"
...
def _bindings() -> tuple[
    ...
    source_paths = [
        ...
        (EVIDENCE_ROOT / "p1-fragments/C8.json", "p1_fragment"),
        (
            REPOSITORY_ROOT / "main/backend/app/services/typed_knowledge/contracts.py",
        ...
        (
            REPOSITORY_ROOT / "main/backend/app/services/graph/projection.py",
            "legacy_donor_c8_4_graph_projection",
        ),
        (
            REPOSITORY_ROOT / "main/backend/app/services/graph/models.py",
    ...
    implementation_paths = [
        ...
        (
            REPOSITORY_ROOT / "main/backend/app/successor_migration/legacy_c8_graph.py",
            "legacy_c8_4_graph",
        ),
        (
            REPOSITORY_ROOT
    ...
    test_paths = [
        (
            REPOSITORY_ROOT / "main/backend/tests/successor_runtime/p4_c8_fixture.py",
            "captured_fixture",
        ),
        (
            REPOSITORY_ROOT

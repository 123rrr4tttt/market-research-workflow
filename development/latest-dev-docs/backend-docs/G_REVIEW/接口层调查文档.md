...
> Status: HISTORICAL ARCHITECTURE SURVEY COPY. The route counts and line numbers below are 2026-02 era notes. For current route inventory, use [`../B_API/API_ROUTE_MAP_2026-05-22.md`](../B_API/API_ROUTE_MAP_2026-05-22.md), which finds 250 routes across 30 API modules.
...
| `ingest.py` | `/ingest` | 13 | 数据采集入口（政策/市场/新闻/报告/商品/数据API） |

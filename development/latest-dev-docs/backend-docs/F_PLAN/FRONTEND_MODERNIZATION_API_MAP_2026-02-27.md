...
> Status: PARTIAL HISTORICAL MIGRATION MAP. Keep the P0 frontend intent, but validate every route against [`../B_API/API_ROUTE_MAP_2026-05-22.md`](../B_API/API_ROUTE_MAP_2026-05-22.md) before using this as implementation input.
...
- 当前全量路由盘点：[`../B_API/API_ROUTE_MAP_2026-05-22.md`](../B_API/API_ROUTE_MAP_2026-05-22.md)（自动解析，250 条）
- 历史路由盘点：[`../B_API/API_ROUTE_INVENTORY_2026-02-27.md`](../B_API/API_ROUTE_INVENTORY_2026-02-27.md)（自动解析，135 条；仅作历史证据）

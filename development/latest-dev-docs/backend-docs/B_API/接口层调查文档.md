...
> Status: HISTORICAL ARCHITECTURE SURVEY. The route counts and line numbers below are 2026-02 era notes. For current route inventory, use [`API_ROUTE_MAP_2026-05-22.md`](./API_ROUTE_MAP_2026-05-22.md), which finds 250 routes across 30 API modules.

# 结构化提取与图谱元素对齐说明 Compatibility Shim
...
- [docs/architecture/backend-docs/A_ARCHITECTURE/STRUCTURED_VS_GRAPH_ALIGNMENT.md](../../../../docs/architecture/backend-docs/A_ARCHITECTURE/STRUCTURED_VS_GRAPH_ALIGNMENT.md)

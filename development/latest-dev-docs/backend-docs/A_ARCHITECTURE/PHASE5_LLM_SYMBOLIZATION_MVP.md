# Phase 5：LLM+符号化 最小可行方案设计 Compatibility Shim
...
- [docs/architecture/backend-docs/A_ARCHITECTURE/PHASE5_LLM_SYMBOLIZATION_MVP.md](../../../../docs/architecture/backend-docs/A_ARCHITECTURE/PHASE5_LLM_SYMBOLIZATION_MVP.md)

...
- readiness checker exit code is nonzero until `closure.full_closure_allowed=true`; `readiness_checks_passed=true` records the reduced external-blocked state without claiming closure.

...
- [2026-03-14 Search Chain Source-Library Mounting Audit](./2026-03-14-search-chain-source-library-mounting-audit/)
  状态：`external_blocked` / `wave21_checked` / `wave33_checked`。仓内 mount governance 与 deterministic review batch 已封住；Wave33 复核无新增 repo-local blocker；Wave49 已补齐 shared 45-site public replay；剩余条件是 human review、live source collection、live ingest migration 和真实治理动作读回。

...
- `closed` [2026-03-11-source-library-three-lane-architecture](../../../../docs/development/development-plans/ARCHIVE_CLOSED/2026-03-11-source-library-three-lane-architecture/16_wave57-human-review-closure-2026-05-23.md) - Wave49 已补 shared 45-site public replay，Wave55 已补 live source collection / provider article extraction readback，Wave57 已补 completed human review evidence
...
- `external_blocked` [2026-03-14-time-semantics-density-merged-plan](../ARCHIVE_EXTERNAL_BLOCKED/2026-03-14-time-semantics-density-merged-plan/13_wave56-configured-live-semantic-chain-evidence-2026-05-24.md) - repo-local release gate、source-time distribution、decision-log feature readback 与 configured production-like DB evidence 已接入；strict production/live semantic-chain validation 未闭环
- `closed` [2026-05-14-local-open-search-provider-isolation](../../../../docs/development/development-plans/ARCHIVE_CLOSED/2026-05-14-local-open-search-provider-isolation/17_wave42-manual-open-search-live-closure-2026-05-23.md) - Wave42 已验证 SearXNG / YaCy live availability、provider quality/freshness/latency 与 `provider=auto` promotion 条件
...
- `external_blocked` [2026-03-08-llm-crawler-unified-frontdoor](../ARCHIVE_EXTERNAL_BLOCKED/2026-03-08-llm-crawler-unified-frontdoor/13_wave56-session-aware-high-js-replay-boundary-2026-05-23.md) - five-shard public output、accessible high-JS public replay 与 session-aware replay path 已补齐；Instagram/YouTube pass，X auth-or-anti-bot gate 未闭环
...
- `closed` [2026-03-07-llm-service-and-agent-platformization](../../../../docs/development/development-plans/ARCHIVE_CLOSED/2026-03-07-llm-service-and-agent-platformization/12_wave55-agentcore-external-provider-live-readback-2026-05-24.md) - Wave55 T4 已补齐真实 OpenAI provider/API/account/network invocation、native tool-call readback 与 reviewer readback
...
- `closed` [2026-05-22-clue-chain-successor-scopes](../../../../docs/development/development-plans/ARCHIVE_CLOSED/2026-05-22-clue-chain-successor-scopes/04_wave42-live-provider-reliability-closure-2026-05-23.md) - Clue Chain graph-submit conflict、UI matrix repo-local gates 与 live provider reliability 已闭环
...
- `external_blocked` [2026-03-02-meaningful-ingest-guardrails-plan](../ARCHIVE_EXTERNAL_BLOCKED/2026-03-02-meaningful-ingest-guardrails-plan/13_wave56-strict-promotion-final-gate-2026-05-24.md) - source-policy tuning attachment 已归入 crawler policy matrix；repo-local API/DB canary handoff、strict-promotion readiness 与 final closure input gate 已验证；production 24h guardrail metrics 与 operations strict-gate promotion decision 未闭环
- `external_blocked` [2026-03-02-single-url-first-ingest-allocation-plan](../ARCHIVE_EXTERNAL_BLOCKED/2026-03-02-single-url-first-ingest-allocation-plan/13_wave57-single-url-external-blocker-closure-2026-05-24.md) - broader fetch-router、official API adapter、dashboard tri-state、Crossref public official API provider maturity、Instagram/YouTube public replay、configured canary 与 Crossref live API 已闭；X auth/anti-bot、production 24h readback、ops promotion 与 Crossref 之外的 credential/quota behavior 未闭环
- `closed` [2026-03-05-oss-node-platform-io-plan](../../../../docs/development/development-plans/ARCHIVE_CLOSED/2026-03-05-oss-node-platform-io-plan/11_wave57-oss-node-public-corpus-semantic-relevance-2026-05-23.md) - OSS-node vector manifest runtime replay、Wave55 live scheduler/tenant DB/UI SLA readback、controlled repo-local open-search quality 与 Wave57 public-corpus semantic relevance 已闭
- `closed` [2026-05-14-global-vectorization-general-foundation](../../../../docs/development/development-plans/ARCHIVE_CLOSED/2026-05-14-global-vectorization-general-foundation/14_wave57-production-vector-quality-gate-2026-05-23.md) - retrieval run persistence/readback、qdrant/pgvector payload provenance、Agent matrix/main-search schema join、Wave55 live embedding provider gate、Wave56 semantic quality 与 Wave57 production-like vector quality 已闭
...
| `2026-05-14-global-vectorization-general-foundation` | `closed` | `doc_aligned / wave8_checked / wave10_checked / wave12_checked / wave14_checked / wave18_checked / wave19_checked / wave27_checked / wave29_verified / wave30_checked / wave55_embedding_checked / wave56_semantic_quality_checked / wave57_production_quality_closed` | Wave29 冻结主搜索 `evidence_hits` 与 `global_vector_object` response-level schema；Wave30 关闭 retrieval runs/branches/hits persistence、stored payload provenance 与 Agent matrix/main-search schema joining repo-local blockers；Wave55 关闭 live embedding provider gate；Wave56 关闭 semantic quality；Wave57 关闭 production-like vector quality 并迁入 `ARCHIVE_CLOSED` |

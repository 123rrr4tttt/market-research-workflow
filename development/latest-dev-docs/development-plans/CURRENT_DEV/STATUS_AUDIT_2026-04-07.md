...
| `2026-05-14-local-open-search-provider-isolation` | `partial` | `doc_aligned / external_blocked / wave8_checked / wave12_checked / wave15_checked / wave18_checked / wave19_checked` | Wave6 已补 provider isolation / trace contract evidence，Wave8 复用真实容器 replay summary，Wave12 记录当前 SearXNG/YaCy ConnectError，Wave15 补 runtime boundary gate，Wave18 补 health artifact 并记录 service_not_started_connect_error；当前容器可用性仍未封口；Wave19 已补 health artifact schema/readback；当前服务未启动和 live probe 仍不封口 |
...
| `2026-03-02-graph-node-standardization-a-then-b-plan` | `partial` | `doc_aligned / wave8_checked / wave10_verified / wave12_checked / wave14_checked / wave17_verified / wave19_verified` | Wave7 已补 storage canonical id 规范化与单测；Wave8 已补 no-DB dry-run readmode/backfill contract，Wave10 已补 pre-live DB rollout readiness，Wave12 已补 live-smoke readiness gate，Wave14 已补 live DB rollout gate，Wave17 已补 rollout manifest readback；real tenant DB rollout 仍缺；Wave19 已补 rollout manifest/projection/rollback readback；real tenant DB rollout 仍缺 |
...
| `2026-03-07-crawler-source-expansion` | `partial` | `doc_aligned / external_blocked / wave8_checked / wave13_checked / wave19_checked` | Wave8 已封 A7 validation pack；Wave13 已补 public replay manifest/checker 并把缺少真实 `output.public.json` 标为 not closed；A5 仍受 45-site public replay 外部阻塞；Wave19 已补 public replay shard manifest，把 45-site replay 拆成 5 个 shard；真实 public output 仍 external_blocked |
...
| `2026-03-07-ingest-digestion-and-long-cycle-automation` | `partial` | `doc_aligned / wave9_verified / wave11_verified / wave13_checked / wave16_verified / wave18_verified / wave20_verified` | Wave7 已补 digestion / long-cycle pre-dispatch contract，Wave9 已补 persistent-task lifecycle contract，Wave11 已补 fake repository scheduler E2E contract，Wave13 已补 scheduler readiness/dry-run boundary，Wave16 已补 durable JSONL repository readback / event contract，Wave18 已补 scheduler handoff trace；live scheduler / live DB write / end-to-end automation 仍未闭环；Wave20 已补 scheduler queue handoff replay；live scheduler/live DB write 仍未封口 |
| `2026-03-07-llm-service-and-agent-platformization` | `partial` | `doc_aligned / wave6_verified / wave9_verified / wave11_verified / wave13_checked / wave14_checked / wave18_verified / wave19_verified` | Wave6 已补 AgentCore schema inventory，Wave9 已补 tool-dispatch platform baseline，Wave11 已补 provider matrix 与 external framework boundary，Wave13 已补 live-provider readiness contract，Wave14 已补 native tool-calling quality gate，Wave18 已补 fake-provider trace/tool-call envelope readback；provider live calls 仍需独立闭环；Wave19 已补 provider trace redaction replay；真实外部 provider calls 仍需独立闭环 |
...
| `2026-03-08-llm-crawler-unified-frontdoor` | `partial` | `doc_aligned / wave8_verified / wave10_verified / wave13_checked / wave15_checked / wave18_checked / wave19_checked` | Wave8 已补 fetch-router/frontdoor context closure，Wave10 已补 tri-state router contract，Wave13 已补 high-JS/public replay readiness gate，Wave15 已补 replay manifest/schema gate，Wave18 已补 repo-local browser replay fixture；真实 high-JS browser fleet replay 仍未全封；Wave19 已补 public replay shard manifest/readback；真实 public browser fleet replay 仍未全封 |
| `2026-03-09-agent-symbolic-batch-search-architecture` | `partial` | `doc_aligned / wave9_verified / wave11_verified / wave13_checked / wave15_verified / wave18_checked / wave20_verified` | Wave9 已补 `agent_batch` search brief / critic / bounded retry 确定性门禁，Wave11 已补 fixture quality replay 与 benchmark uplift boundary，Wave13 已补 provider-quality readiness gate，Wave15 已补 live quality threshold contract，Wave18 已补 provider-independent quality regression；live provider quality 仍未封口；Wave20 已补 provider-independent quality promotion/readback；live provider quality 仍未封口 |

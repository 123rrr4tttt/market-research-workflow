...
更新时间：2026-04-07（PST）；2026-05-22 补充 Wave14 状态证据、窄口径合同落地与仍需保留的外部 / 生产化边界。
...
| `2026-03-07-dual-frontend-workbench-topology` | `partial` | `doc_aligned / wave8_verified / wave11_verified / wave12_checked / wave14_checked` | Wave8 已补 topology contract checker 与 lint 证据，Wave11 已补 no-dep layer-shell route/surface contract，Wave12 已补 business-string audit，Wave14 已补 static migration boundary；仍保留更大范围双交互面闭环 |
| `2026-03-07-frontend-i18n-theme-modularization` | `partial` | `doc_aligned / wave8_verified / wave11_verified / wave12_checked / wave14_checked` | Wave8 已补 i18n/theme registry contract evidence，Wave11 已把 theme/i18n anchor 纳入 layer-shell contract，Wave12 已补 business-string audit，Wave14 已补 static migration boundary；仍保留全量业务文案迁移范围 |
...
| `2026-03-07-后续安排` | `partial` | `doc_aligned / wave13_checked / wave14_verified` | Wave6 已补 folderization structure evidence，Wave13 已把该入口收窄为 retained coordination topic，Wave14 已把 downstream content gaps 降为 0；抽象规划后续迁档仍未结束 |
...
| `2026-03-11-source-library-three-lane-architecture` | `partial` | `doc_aligned / wave9_verified / wave12_verified / wave14_checked` | Wave9 已补 legacy item-run `410 Gone` replacement contract，Wave12 已补 relevance review queue，Wave14 已补 taxonomy/review readiness；live source collection、三车道全量分类治理和人工 review 仍未封口 |
...
| `2026-03-14-search-chain-source-library-mounting-audit` | `partial` | `doc_aligned / wave10_checked / wave12_verified / wave14_checked` | 主入口与挂载关系能对上代码，Wave10 已补 source-library search/mount governance checker，Wave12 已补 relevance review queue，Wave14 已补 taxonomy/review readiness；治理动作仍未结束 |
| `2026-03-14-source-library-adapter-capability-remediation` | `partial` | `doc_aligned / wave8_verified / wave10_checked / wave12_verified / wave14_checked` | Wave8 已补 parser-profile capability gate，Wave10 已补 governance gate，Wave12 已补 relevance review queue，Wave14 已补 taxonomy/review readiness；public replay 和人工 relevance review 仍未全封 |
...
| `2026-03-15-frontend-three-layer-rewrite` | `partial` | `doc_aligned / wave8_verified / wave11_verified / wave12_checked / wave14_checked` | Wave8 已补 topology/i18n/theme contract checker，Wave11 已补 layer-shell coverage gate，Wave12 已补 business-string audit，Wave14 已补 static migration boundary；文档与代码仍表明目前是“半重构态” |

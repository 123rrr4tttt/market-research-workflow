...
| `AT-AC-10` | Advanced, not closed: the historical 45-site set is now represented as a deterministic manifest and replay artifact. Dirty-source closure still requires an opt-in public replay in a suitable environment. |

...
- 四态审计摘要以 [Wave45 manual structured/consumer live API closure](./automation-runs/wave45-manual-structured-consumer-live-api-closure/2026-05-23/README.md) 为准：`unsealed:0 / sealed:55 / outdated:6 / needs_update:0`，其中 target topics 为 `closed:32 / external_blocked:23 / retired:6 / active_current:0`。

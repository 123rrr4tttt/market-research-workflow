...
- 四态审计摘要以 Wave52 non-target reclassification 为准：`unsealed:0 / sealed:49 / outdated:6 / needs_update:0`，其中 target topics 为 `closed:36 / external_blocked:13 / retired:6 / active_current:0`，non-target roots 为 `23`。

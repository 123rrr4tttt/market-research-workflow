...
- 四态审计摘要以 Wave53 manual agent symbolic live-provider closure 为准：`unsealed:0 / sealed:49 / outdated:6 / needs_update:0`，其中 target topics 为 `closed:37 / external_blocked:12 / retired:6 / active_current:0`，non-target roots 为 `23`。

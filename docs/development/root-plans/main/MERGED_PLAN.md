> Content moved: this file is now authoritative under `docs/development/root-plans/main/MERGED_PLAN.md`.
> Previous compatibility path: `development/latest-dev-docs/root-plans/main/MERGED_PLAN.md`.

...
> Content moved: this file is now authoritative under `docs/architecture/development-plans/A_ARCHITECTURE/08_main_backend_docs_DOC_MERGE_PLAN.md`.
> Previous compatibility path: `development/latest-dev-docs/development-plans/A_ARCHITECTURE/08_main_backend_docs_DOC_MERGE_PLAN.md`.

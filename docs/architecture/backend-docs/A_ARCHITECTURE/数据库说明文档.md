...
> Content moved: this file is now authoritative under `docs/architecture/backend-docs/A_ARCHITECTURE/数据库说明文档.md`.
> Previous compatibility path: `development/latest-dev-docs/backend-docs/A_ARCHITECTURE/数据库说明文档.md`.

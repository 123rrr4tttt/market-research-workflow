...
> Content moved: this file is now authoritative under `docs/architecture/backend-docs/A_ARCHITECTURE/UNIFIED_COLLECT_ARCHITECTURE.md`.
> Previous compatibility path: `development/latest-dev-docs/backend-docs/A_ARCHITECTURE/UNIFIED_COLLECT_ARCHITECTURE.md`.

...
> Content moved: this file is now authoritative under `docs/architecture/backend-docs/A_ARCHITECTURE/STRUCTURED_VS_GRAPH_ALIGNMENT.md`.
> Previous compatibility path: `development/latest-dev-docs/backend-docs/A_ARCHITECTURE/STRUCTURED_VS_GRAPH_ALIGNMENT.md`.

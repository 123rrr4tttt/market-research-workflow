...
> Content moved: this file is now authoritative under `docs/architecture/backend-docs/A_ARCHITECTURE/政策数据结构说明.md`.
> Previous compatibility path: `development/latest-dev-docs/backend-docs/A_ARCHITECTURE/政策数据结构说明.md`.
...
- [数据摄取内容](../../../../development/latest-dev-docs/backend-docs/C_INGEST/数据摄取内容.md) - 数据摄取流程说明
- [结构化搜索管道](../../../../main/backend/STRUCTURED_SEARCH_PIPELINE.md) - 结构化数据搜索说明

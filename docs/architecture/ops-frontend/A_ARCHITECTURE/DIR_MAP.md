...
> Content moved: this file is now authoritative under `docs/architecture/ops-frontend/A_ARCHITECTURE/DIR_MAP.md`.
> Previous compatibility path: `development/latest-dev-docs/ops-frontend/A_ARCHITECTURE/DIR_MAP.md`.
> 更新日期：2026-03-01 (PST)
...
1. [INDEX.md](../../../../development/latest-dev-docs/ops-frontend/INDEX.md)
2. [QUICKSTART.md](../../../../development/latest-dev-docs/ops-frontend/E_OPS/QUICKSTART.md)
3. [ops-README.md](../../../../development/latest-dev-docs/ops-frontend/E_OPS/ops-README.md)
4. [frontend-modern-README.md](./frontend-modern-README.md)
5. [MERGED_OPS_FRONTEND_REVIEW.md](../../../../development/latest-dev-docs/ops-frontend/G_REVIEW/MERGED_OPS_FRONTEND_REVIEW.md)

...
> Content moved: this file is now authoritative under `docs/architecture/ops-frontend/A_ARCHITECTURE/frontend-modern-README.md`.
> Previous compatibility path: `development/latest-dev-docs/ops-frontend/A_ARCHITECTURE/frontend-modern-README.md`.

入口总览：
- [根索引](../../../../development/latest-dev-docs/ops-frontend/INDEX.md)
- [Docker 启动指南](../../../../development/latest-dev-docs/ops-frontend/E_OPS/ops-README.md)
- [合并评审记录](../../../../development/latest-dev-docs/ops-frontend/G_REVIEW/MERGED_OPS_FRONTEND_REVIEW.md)
...
接口盘点见：
- `../../../../main/backend/docs/API_ROUTE_INVENTORY_2026-02-27.md`
- `../../../../main/backend/docs/FRONTEND_MODERNIZATION_API_MAP_2026-02-27.md`

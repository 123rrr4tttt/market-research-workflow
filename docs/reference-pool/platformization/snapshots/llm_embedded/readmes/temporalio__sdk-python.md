...
URL Source: http://github.com/temporalio/sdk-python

Markdown Content:
[![Image 1: Temporal Python SDK](https://camo.githubusercontent.com/b34040758954da9334b1fd8588bd0a0cd26eb86efb00745c494622dfa6043fcb/68747470733a2f2f6173736574732e74656d706f72616c2e696f2f772f70792d62616e6e65722e737667)](https://camo.githubusercontent.com/b34040758954da9334b1fd8588bd0a0cd26eb86efb00745c494622dfa6043fcb/68747470733a2f2f6173736574732e74656d706f72616c2e696f2f772f70792d62616e6e65722e737667)

[![Image 2: Python 3.9+](https://camo.githubusercontent.com/af8316a04d217f869e0ba2cb6a25c69e6185c089575f749107bfd4e472bc79b4/68747470733a2f2f696d672e736869656c64732e696f2f707970692f707976657273696f6e732f74656d706f72616c696f2e7376673f7374796c653d666f722d7468652d6261646765)](https://pypi.org/project/temporalio)[![Image 3: PyPI](https://camo.githubusercontent.com/ed4a69b5f21957947f1808ba06522aefe30d10f94a672c5fab013626e2b30ad0/68747470733a2f2f696d672e736869656c64732e696f2f707970692f762f74656d706f72616c696f2e7376673f7374796c653d666f722d7468652d6261646765)](https://pypi.org/project/temporalio)[![Image 4: MIT](https://camo.githubusercontent.com/77a9372763a01de28f31d0a51830183f641aa01f88ad701c6bfeff1fbfa8a64d/68747470733a2f2f696d672e736869656c64732e696f2f707970692f6c2f74656d706f72616c696f2e7376673f7374796c653d666f722d7468652d6261646765)](https://github.com/temporalio/sdk-python/blob/main/LICENSE)

**📣 News: Integration between OpenAI Agents SDK and Temporal is now in public preview. [Learn more](https://github.com/temporalio/sdk-python/blob/main/temporalio/contrib/openai_agents/README.md).**
...
*   [Application Development Guide](https://docs.temporal.io/application-development?lang=python) - Once you've tried our [Quick Start](http://github.com/temporalio/sdk-python#quick-start), check out our guide on how to use Temporal in your Python applications, including information around Temporal core concepts.
...
See the [blog post](https://temporal.io/blog/durable-distributed-asyncio-event-loop) introducing the Python SDK for an informal introduction to the features and their implementation.

* * *

**Contents**

*   [Quick Start](http://github.com/temporalio/sdk-python#quick-start)
    *   [Installation](http://github.com/temporalio/sdk-python#installation)
    *   [Implementing a Workflow](http://github.com/temporalio/sdk-python#implementing-a-workflow)
    *   [Running a Workflow](http://github.com/temporalio/sdk-python#running-a-workflow)
    *   [Next Steps](http://github.com/temporalio/sdk-python#next-steps)

*   [Usage](http://github.com/temporalio/sdk-python#usage)
    *   [Client](http://github.com/temporalio/sdk-python#client)
        *   [Data Conversion](http://github.com/temporalio/sdk-python#data-conversion)
            *   [Pydantic Support](http://github.com/temporalio/sdk-python#pydantic-support)
            *   [Custom Type Data Conversion](http://github.com/temporalio/sdk-python#custom-type-data-conversion)

    *   [Workers](http://github.com/temporalio/sdk-python#workers)
    *   [Workflows](http://github.com/temporalio/sdk-python#workflows)
        *   [Definition](http://github.com/temporalio/sdk-python#definition)
        *   [Running](http://github.com/temporalio/sdk-python#running)
        *   [Invoking Activities](http://github.com/temporalio/sdk-python#invoking-activities)
        *   [Invoking Child Workflows](http://github.com/temporalio/sdk-python#invoking-child-workflows)
        *   [Timers](http://github.com/temporalio/sdk-python#timers)
        *   [Conditions](http://github.com/temporalio/sdk-python#conditions)
        *   [Asyncio and Determinism](http://github.com/temporalio/sdk-python#asyncio-and-determinism)
        *   [Asyncio Cancellation](http://github.com/temporalio/sdk-python#asyncio-cancellation)
        *   [Workflow Utilities](http://github.com/temporalio/sdk-python#workflow-utilities)
        *   [Exceptions](http://github.com/temporalio/sdk-python#exceptions)
        *   [Signal and update handlers](http://github.com/temporalio/sdk-python#signal-and-update-handlers)
        *   [External Workflows](http://github.com/temporalio/sdk-python#external-workflows)
        *   [Testing](http://github.com/temporalio/sdk-python#testing)
            *   [Automatic Time Skipping](http://github.com/temporalio/sdk-python#automatic-time-skipping)
            *   [Manual Time Skipping](http://github.com/temporalio/sdk-python#manual-time-skipping)
            *   [Mocking Activities](http://github.com/temporalio/sdk-python#mocking-activities)

        *   [Workflow Sandbox](http://github.com/temporalio/sdk-python#workflow-sandbox)
            *   [How the Sandbox Works](http://github.com/temporalio/sdk-python#how-the-sandbox-works)
            *   [Avoiding the Sandbox](http://github.com/temporalio/sdk-python#avoiding-the-sandbox)
            *   [Customizing the Sandbox](http://github.com/temporalio/sdk-python#customizing-the-sandbox)
                *   [Passthrough Modules](http://github.com/temporalio/sdk-python#passthrough-modules)
                *   [Invalid Module Members](http://github.com/temporalio/sdk-python#invalid-module-members)

            *   [Known Sandbox Issues](http://github.com/temporalio/sdk-python#known-sandbox-issues)
                *   [Global Import/Builtins](http://github.com/temporalio/sdk-python#global-importbuiltins)
                *   [Sandbox is not Secure](http://github.com/temporalio/sdk-python#sandbox-is-not-secure)
                *   [Sandbox Performance](http://github.com/temporalio/sdk-python#sandbox-performance)
                *   [Extending Restricted Classes](http://github.com/temporalio/sdk-python#extending-restricted-classes)
                *   [Certain Standard Library Calls on Restricted Objects](http://github.com/temporalio/sdk-python#certain-standard-library-calls-on-restricted-objects)
                *   [is_subclass of ABC-based Restricted Classes](http://github.com/temporalio/sdk-python#is_subclass-of-abc-based-restricted-classes)

    *   [Activities](http://github.com/temporalio/sdk-python#activities)
        *   [Definition](http://github.com/temporalio/sdk-python#definition-1)
        *   [Types of Activities](http://github.com/temporalio/sdk-python#types-of-activities)
            *   [Synchronous Activities](http://github.com/temporalio/sdk-python#synchronous-activities)
                *   [Synchronous Multithreaded Activities](http://github.com/temporalio/sdk-python#synchronous-multithreaded-activities)
                *   [Synchronous Multiprocess/Other Activities](http://github.com/temporalio/sdk-python#synchronous-multiprocessother-activities)

            *   [Asynchronous Activities](http://github.com/temporalio/sdk-python#asynchronous-activities)

        *   [Activity Context](http://github.com/temporalio/sdk-python#activity-context)
            *   [Heartbeating and Cancellation](http://github.com/temporalio/sdk-python#heartbeating-and-cancellation)
            *   [Worker Shutdown](http://github.com/temporalio/sdk-python#worker-shutdown)

        *   [Testing](http://github.com/temporalio/sdk-python#testing-1)

    *   [Interceptors](http://github.com/temporalio/sdk-python#interceptors)
    *   [Nexus](http://github.com/temporalio/sdk-python#nexus)
    *   [Plugins](http://github.com/temporalio/sdk-python#plugins)
        *   [Usage](http://github.com/temporalio/sdk-python#usage-1)
        *   [Plugin Implementations](http://github.com/temporalio/sdk-python#plugin-implementations)
        *   [Advanced Plugin Implementations](http://github.com/temporalio/sdk-python#advanced-plugin-implementations)
            *   [Client Plugins](http://github.com/temporalio/sdk-python#client-plugins)
            *   [Worker Plugins](http://github.com/temporalio/sdk-python#worker-plugins)

    *   [Workflow Replay](http://github.com/temporalio/sdk-python#workflow-replay)
    *   [Observability](http://github.com/temporalio/sdk-python#observability)
        *   [Metrics](http://github.com/temporalio/sdk-python#metrics)
        *   [OpenTelemetry Tracing](http://github.com/temporalio/sdk-python#opentelemetry-tracing)

    *   [Protobuf 3.x vs 4.x](http://github.com/temporalio/sdk-python#protobuf-3x-vs-4x)
    *   [Known Compatibility Issues](http://github.com/temporalio/sdk-python#known-compatibility-issues)
        *   [gevent Patching](http://github.com/temporalio/sdk-python#gevent-patching)

*   [Development](http://github.com/temporalio/sdk-python#development)
    *   [Building](http://github.com/temporalio/sdk-python#building)
        *   [Prepare](http://github.com/temporalio/sdk-python#prepare)
        *   [Build](http://github.com/temporalio/sdk-python#build)
        *   [Use](http://github.com/temporalio/sdk-python#use)

    *   [Local SDK development environment](http://github.com/temporalio/sdk-python#local-sdk-development-environment)
        *   [Testing](http://github.com/temporalio/sdk-python#testing-2)
        *   [Proto Generation and Testing](http://github.com/temporalio/sdk-python#proto-generation-and-testing)

    *   [Style](http://github.com/temporalio/sdk-python#style)

Quick Start
-----------

[](http://github.com/temporalio/sdk-python#quick-start)
...
[](http://github.com/temporalio/sdk-python#installation)
...
[](http://github.com/temporalio/sdk-python#implementing-a-workflow)
...
Assuming you have a [Temporal server running on localhost](https://docs.temporal.io/docs/server/quick-install/), this will run the worker:
...
[](http://github.com/temporalio/sdk-python#running-a-workflow)
...
[](http://github.com/temporalio/sdk-python#next-steps)
...
[](http://github.com/temporalio/sdk-python#usage)
From here, you will find reference documentation about specific pieces of the Temporal Python SDK that were built around Temporal concepts. _This section is not intended as a how-to guide_ -- For more how-to oriented information, check out the links in the [Next Steps](http://github.com/temporalio/sdk-python#next-steps) section above.

### Client

[](http://github.com/temporalio/sdk-python#client)
...
[](http://github.com/temporalio/sdk-python#data-conversion)
Data converters are used to convert raw Temporal payloads to/from actual Python types. A custom data converter of type `temporalio.converter.DataConverter` can be set via the `data_converter` parameter of the `Client` constructor. Data converters are a combination of payload converters, payload codecs, and failure converters. Payload converters convert Python values to/from serialized bytes. Payload codecs convert bytes to bytes (e.g. for compression or encryption). Failure converters convert exceptions to/from serialized failures.
...
To use pydantic model instances, see [Pydantic Support](http://github.com/temporalio/sdk-python#pydantic-support).
...
[](http://github.com/temporalio/sdk-python#pydantic-support)
...
Pydantic v1 is not supported by this data converter. If you are not yet able to upgrade from Pydantic v1, see [https://github.com/temporalio/samples-python/tree/main/pydantic_converter/v1](https://github.com/temporalio/samples-python/tree/main/pydantic_converter/v1) for limited v1 support.

##### Custom Type Data Conversion

[](http://github.com/temporalio/sdk-python#custom-type-data-conversion)
...
The default data converter uses the `DefaultPayloadConverter` which is simply a `CompositePayloadConverter` with a known set of default `EncodingPayloadConverter`s. To implement a custom encoding for a custom type, a new `EncodingPayloadConverter` can be created for the new type. For example, to support `IPv4Address` types:
...
The `JSONPlainPayloadConverter` uses the Python [json](https://docs.python.org/3/library/json.html) library with an advanced JSON encoder by default and a custom value conversion method to turn `json.load`ed values to their type hints. The conversion can be customized for serialization with a custom `json.JSONEncoder` and deserialization with a custom `JSONTypeConverter`. For example, to support `IPv4Address` types in existing JSON conversion:
...
[](http://github.com/temporalio/sdk-python#workers)
...
[](http://github.com/temporalio/sdk-python#workflows)
#### Definition

[](http://github.com/temporalio/sdk-python#definition)
...
*   Workflows run in a sandbox by default. 
    ...
    *   Non-standard-library, non-`temporalio` imports should usually be "passed through" the sandbox. See the [Workflow Sandbox](http://github.com/temporalio/sdk-python#workflow-sandbox) section for more details.
...
*   Workflow code must be deterministic. This means no `set` iteration, threading, no randomness, no external calls to processes, no network IO, and no global state mutation. All code must run in the implicit `asyncio` event loop and be deterministic. Also see the [Asyncio and Determinism](http://github.com/temporalio/sdk-python#asyncio-and-determinism) section later.
...
*   `@workflow.run` - Defines the primary workflow run method 
    *   Must be defined on the same class as `@workflow.defn`, not a base class (but can _also_ be defined on the same method of a base class)
...
*   `@workflow.init` - Specifies that the `__init__` method accepts the workflow's arguments. 
    *   If present, may only be applied to the `__init__` method, the parameters of which must then be identical to those of the `@workflow.run` method.
    *   The purpose of this decorator is to allow operations involving workflow arguments to be performed in the `__init__` method, before any signal or update handler has a chance to execute.

*   `@workflow.signal` - Defines a method as a signal 
    *   Can be defined on an `async` or non-`async` method at any point in the class hierarchy, but if the decorated method is overridden, then the override must also be decorated.
    ...
    *   See [Signal and update handlers](http://github.com/temporalio/sdk-python#signal-and-update-handlers) below
...
[](http://github.com/temporalio/sdk-python#running)
...
[](http://github.com/temporalio/sdk-python#invoking-activities)
...
*   An async `workflow.execute_activity()` helper is provided which takes the same arguments as `workflow.start_activity()` and `await`s on the result. This should be used in most cases unless advanced task capabilities are needed.
...
[](http://github.com/temporalio/sdk-python#invoking-child-workflows)
...
*   An async `workflow.execute_child_workflow()` helper is provided which takes the same arguments as `workflow.start_child_workflow()` and `await`s on the result. This should be used in most cases unless advanced task capabilities are needed.

#### Timers

[](http://github.com/temporalio/sdk-python#timers)
...
[](http://github.com/temporalio/sdk-python#conditions)
...
[](http://github.com/temporalio/sdk-python#asyncio-and-determinism)
Workflows must be deterministic. Workflows are backed by a custom [asyncio](https://docs.python.org/3/library/asyncio.html) event loop. This means many of the common `asyncio` calls work as normal. Some asyncio features are disabled such as:
...
[](http://github.com/temporalio/sdk-python#workflow-utilities)
...
[](http://github.com/temporalio/sdk-python#exceptions)
*   Workflows/updates can raise exceptions to fail the workflow or the "workflow task" (i.e. suspend the workflow in a retrying state).
...
*   Update handlers are special: an instance of `temporalio.exceptions.FailureError` raised in an update handler will fail the update instead of failing the workflow.
...
[](http://github.com/temporalio/sdk-python#external-workflows)
...
[](http://github.com/temporalio/sdk-python#testing)
...
[](http://github.com/temporalio/sdk-python#automatic-time-skipping)
...
[](http://github.com/temporalio/sdk-python#manual-time-skipping)
...
[](http://github.com/temporalio/sdk-python#mocking-activities)
...
[](http://github.com/temporalio/sdk-python#workflow-sandbox)
...
The sandbox offers a mechanism to "pass through" modules from outside the sandbox. By default this already includes all standard library modules and Temporal modules. **For performance and behavior reasons, users are encouraged to pass through all modules whose calls will be deterministic.** In particular, this advice extends to modules containing the activities to be referenced in workflows, and modules containing dataclasses and Pydantic models, which can be particularly expensive to import. See "Passthrough Modules" below on how to do this.

##### How the Sandbox Works

[](http://github.com/temporalio/sdk-python#how-the-sandbox-works)
...
Global state isolation is performed by using `exec`. Upon workflow start, and every time that the workflow is replayed, the file that the workflow is defined in is re-imported into a new sandbox created for that workflow run. In order to keep the sandbox performant, not all modules are re-imported in this way: instead, a known set of "passthrough modules" are obtained as references to the already-imported module _outside_ the sandbox. These modules should be side-effect free on import and, if they make any non-deterministic calls, then these should be restricted by sandbox restriction rules. By default the entire Python standard library, `temporalio`, and a couple of other modules are "passed through" in this way from outside of the sandbox. To update this list, see "Customizing the Sandbox".
...
[](http://github.com/temporalio/sdk-python#avoiding-the-sandbox)
There are three increasingly-scoped ways to avoid the sandbox. Users are discouraged from avoiding the sandbox if possible, except for passing through safe modules, which is recommended.
...
To run an entire workflow outside of a sandbox, set `sandboxed=False` on the `@workflow.defn` decorator when defining it. This will run the entire workflow outside of the sandbox which means it can share global state and other bad things.
...
[](http://github.com/temporalio/sdk-python#customizing-the-sandbox)
...
[](http://github.com/temporalio/sdk-python#passthrough-modules)
By default the sandbox completely reloads non-standard-library and non-Temporal modules for every workflow run. To make the sandbox quicker and use less memory when importing known-side-effect-free modules, they can be marked as passthrough modules.

**For performance and behavior reasons, users are encouraged to pass through all third party modules whose calls will be deterministic.** In particular, this advice extends to modules containing the activities to be referenced in workflows, and modules containing dataclasses and Pydantic models, which can be particularly expensive to import.
...
[](http://github.com/temporalio/sdk-python#invalid-module-members)
...
[](http://github.com/temporalio/sdk-python#known-sandbox-issues)
Below are known sandbox issues. As the sandbox is developed and matures, some may be resolved.

###### Global Import/Builtins

[](http://github.com/temporalio/sdk-python#global-importbuiltins)
...
[](http://github.com/temporalio/sdk-python#sandbox-is-not-secure)
...
[](http://github.com/temporalio/sdk-python#sandbox-performance)
...
[](http://github.com/temporalio/sdk-python#extending-restricted-classes)
...
[](http://github.com/temporalio/sdk-python#certain-standard-library-calls-on-restricted-objects)
...
[](http://github.com/temporalio/sdk-python#is_subclass-of-abc-based-restricted-classes)
Due to [https://bugs.python.org/issue44847](https://bugs.python.org/issue44847), classes that are wrapped and then checked to see if they are subclasses of another via `is_subclass` may fail (see also [this wrapt issue](https://github.com/GrahamDumpleton/wrapt/issues/130)).

### Activities

[](http://github.com/temporalio/sdk-python#activities)
#### Definition

[](http://github.com/temporalio/sdk-python#definition-1)
...
[](http://github.com/temporalio/sdk-python#types-of-activities)
...
[](http://github.com/temporalio/sdk-python#synchronous-activities)
...
Note, all calls from an activity to functions in the `temporalio.activity` package are powered by [contextvars](https://docs.python.org/3/library/contextvars.html). Therefore, new threads starting _inside_ of activities must `copy_context()` and then `.run()` manually to ensure `temporalio.activity` calls like `heartbeat` still function in the new threads.
...
[](http://github.com/temporalio/sdk-python#synchronous-multithreaded-activities)
...
[](http://github.com/temporalio/sdk-python#synchronous-multiprocessother-activities)
...
Also, all of these activity functions must be ["picklable"](https://docs.python.org/3/library/pickle.html#what-can-be-pickled-and-unpickled).

##### Asynchronous Activities

[](http://github.com/temporalio/sdk-python#asynchronous-activities)
...
Cancellation for asynchronous activities is done via [`asyncio.Task.cancel`](https://docs.python.org/3/library/asyncio-task.html#asyncio.Task.cancel). This means that `asyncio.CancelledError` will be raised (and can be caught, but it is not recommended). A non-local activity must heartbeat to receive cancellation and there are other ways to be notified about cancellation (see "Activity Context" and "Heartbeating and Cancellation" later).

#### Activity Context

[](http://github.com/temporalio/sdk-python#activity-context)
During activity execution, an implicit activity context is set as a [context variable](https://docs.python.org/3/library/contextvars.html). The context variable itself is not visible, but calls in the `temporalio.activity` package make use of it. Specifically:
...
[](http://github.com/temporalio/sdk-python#heartbeating-and-cancellation)
...
[](http://github.com/temporalio/sdk-python#worker-shutdown)
...
[](http://github.com/temporalio/sdk-python#testing-1)
...
[](http://github.com/temporalio/sdk-python#interceptors)
The behavior of the SDK can be customized in many useful ways by modifying inbound and outbound calls using interceptors. This is similar to the use of middleware in other frameworks.
...
[Nexus](https://github.com/nexus-rpc/) is a synchronous RPC protocol. Arbitrary duration operations that can respond asynchronously are modeled on top of a set of pre-defined synchronous RPCs.

Temporal supports calling Nexus operations **from a workflow**. See [https://docs.temporal.io/nexus](https://docs.temporal.io/nexus). There is no support currently for calling a Nexus operation from non-workflow code.

To get started quickly using Nexus with Temporal, see the Python Nexus sample: [https://github.com/temporalio/samples-python/tree/nexus/hello_nexus](https://github.com/temporalio/samples-python/tree/nexus/hello_nexus).

Two types of Nexus operation are supported, each using a decorator:

*   `@temporalio.nexus.workflow_run_operation`: a Nexus operation that is backed by a Temporal workflow. The operation handler you write will start the handler workflow and then respond with a token indicating that the handler workflow is in progress. When the handler workflow completes, Temporal server will automatically deliver the result (success or failure) to the caller workflow.
*   `@nexusrpc.handler.sync_operation`: an operation that responds synchronously. It may be `def` or `async def` and it may do network I/O, but it must respond within 10 seconds.

The following steps are an overview of the [Python Nexus sample](https://github.com/temporalio/samples-python/tree/nexus/hello_nexus).
...
``` 
2.   Define your service contract. This specifies the names and input/output types of your operations. You will use this to refer to the operations when calling them from a workflow.
...
[](http://github.com/temporalio/sdk-python#plugins)
Plugins provide a way to extend and customize the behavior of Temporal clients and workers through a chain of responsibility pattern. They allow you to intercept and modify client creation, service connections, worker configuration, and worker execution. Common customizations may include but are not limited to:
...
[](http://github.com/temporalio/sdk-python#usage-1)
...
[](http://github.com/temporalio/sdk-python#plugin-implementations)
The easiest way to create your own plugin is to use `SimplePlugin`. This takes a number of possible configurations to produce a relatively straightforward plugin.
...
[](http://github.com/temporalio/sdk-python#advanced-plugin-implementations)
`SimplePlugin` doesn't cover all possible uses of plugins. For more unusual use cases, an implementor can implement the underlying plugin interfaces directly.

A single plugin class can implement both client and worker plugin interfaces to share common logic between both contexts. When used with a client, it will automatically be propagated to any workers created with that client.

##### Client Plugins

[](http://github.com/temporalio/sdk-python#client-plugins)
Client plugins can intercept and modify client configuration and service connections. They are useful for adding authentication, modifying connection parameters, or adding custom behavior during client creation.
...
[](http://github.com/temporalio/sdk-python#worker-plugins)
...
[](http://github.com/temporalio/sdk-python#workflow-replay)
Given a workflow's history, it can be replayed locally to check for things like non-determinism errors. For example, assuming `history_str` is populated with a JSON string history either exported from the web UI or from the `Temporal CLI`, the following function will replay it:
...
[](http://github.com/temporalio/sdk-python#observability)
See [https://github.com/temporalio/samples-python/tree/main/open_telemetry](https://github.com/temporalio/samples-python/tree/main/open_telemetry) for a sample demonstrating collection of metrics and tracing data emitted by the SDK.

#### Metrics

[](http://github.com/temporalio/sdk-python#metrics)
The SDK emits various metrics by default: see [https://docs.temporal.io/references/sdk-metrics](https://docs.temporal.io/references/sdk-metrics). To configure additional attributes to be emitted with all metrics, pass [global_tags](https://python.temporal.io/temporalio.runtime.TelemetryConfig.html#global_tags) when creating the [TelemetryConfig](https://python.temporal.io/temporalio.runtime.TelemetryConfig.html).

For emitting custom metrics, the SDK makes a metric meter available:

*   In Workflow code, use [https://python.temporal.io/temporalio.workflow.html#metric_meter](https://python.temporal.io/temporalio.workflow.html#metric_meter)
*   In Activity code, use [https://python.temporal.io/temporalio.activity.html#metric_meter](https://python.temporal.io/temporalio.activity.html#metric_meter)
*   In normal application code, use [https://python.temporal.io/temporalio.runtime.Runtime.html#metric_meter](https://python.temporal.io/temporalio.runtime.Runtime.html#metric_meter)

The attributes emitted by these default to `namespace`, `task_queue`, and `workflow_type`/`activity_type`; use `with_additional_attributes` to create a meter emitting additional attributes.

#### OpenTelemetry Tracing

[](http://github.com/temporalio/sdk-python#opentelemetry-tracing)
Tracing support requires the optional `opentelemetry` dependencies which are part of the `opentelemetry` extra. When using `pip`, running
...
[](http://github.com/temporalio/sdk-python#protobuf-3x-vs-4x)
...
To support these, Temporal Python SDK allows any protobuf library >= 3.19. However, the C extension in older Python versions can cause issues with the sandbox due to global state sharing. Temporal strongly recommends using the latest protobuf 4.x library unless you absolutely cannot at which point some proto libraries may have to be marked as [Passthrough Modules](http://github.com/temporalio/sdk-python#passthrough-modules).

### Known Compatibility Issues

[](http://github.com/temporalio/sdk-python#known-compatibility-issues)
Below are known compatibility issues with the Python SDK.

#### gevent Patching

[](http://github.com/temporalio/sdk-python#gevent-patching)
When using `gevent.monkey.patch_all()`, asyncio event loops can get messed up, especially those using custom event loops like Temporal. See [this gevent issue](https://github.com/gevent/gevent/issues/982). This is a known incompatibility and users are encouraged to not use gevent in asyncio applications (including Temporal). But if you must, there is [a sample](https://github.com/temporalio/samples-python/tree/main/gevent_async) showing how it is possible.

Development
-----------

[](http://github.com/temporalio/sdk-python#development)
The Python SDK is built to work with Python 3.9 and newer. It is built using [SDK Core](https://github.com/temporalio/sdk-core/) which is written in Rust.

### Building

[](http://github.com/temporalio/sdk-python#building)
#### Prepare

[](http://github.com/temporalio/sdk-python#prepare)
...
[](http://github.com/temporalio/sdk-python#build)
Now perform the release build:

> This will take a while because Rust will compile the core project in release mode (see [Local SDK development environment](http://github.com/temporalio/sdk-python#local-sdk-development-environment) for the quicker approach to local development).
...
[](http://github.com/temporalio/sdk-python#use)
The wheel can now be installed into any virtual environment.

For example, [create a virtual environment](https://packaging.python.org/en/latest/tutorials/installing-packages/#creating-virtual-environments) somewhere and then run the following inside the virtual environment:
...
Assuming there is a [local Temporal server](https://docs.temporal.io/docs/server/quick-install/) running, execute the file with `python` (or `python3` if necessary):
...
[](http://github.com/temporalio/sdk-python#local-sdk-development-environment)
For local development, it is quicker to use a debug build.

Perform the same steps as the "Prepare" section above by installing the prerequisites, cloning the project, and installing dependencies:
...
[](http://github.com/temporalio/sdk-python#testing-2)
To execute tests:

poe test

This runs against [Temporalite](https://github.com/temporalio/temporalite). To run against the time-skipping test server, pass `--workflow-environment time-skipping`. To run against the `default` namespace of an already-running server, pass the `host:port` to `--workflow-environment`. Can also use regular pytest arguments. For example, here's how to run a single test with debug logs on the console:

poe test -s --log-cli-level=DEBUG -k test_sync_activity_thread_cancel_caught

#### Proto Generation and Testing

[](http://github.com/temporalio/sdk-python#proto-generation-and-testing)
...
Alternatively: to generate protobuf code, you must be on Python <= 3.10, and then run `uv add "protobuf<4"` + `uv sync --all-extras`. Then the protobuf files can be generated via `poe gen-protos` followed by `poe format`. Do not commit `uv.lock` or `pyproject.toml` changes. To go back from this downgrade, restore both of those files and run `uv sync --all-extras`. Tests can be run for protobuf version 3 by setting the `TEMPORAL_TEST_PROTO3` env var to `1` prior to running tests.

### Style

[](http://github.com/temporalio/sdk-python#style)

#!/usr/bin/env python3
"""Validate the Wave15 CURRENT_DEV worktree plan."""
...
PLAN_PATH = Path(
    ...
    "wave15-worktree-plan-2026-05-22.md"
)
INTEGRATION_BRANCH = "codex/devdocs-wave15-integration-2026-05-22"
SUPERVISOR_BRANCH = "codex/devdocs-supervisor-seed"

EXPECTED_BRANCHES = [
    "codex/devdocs-wave15-open-search-runtime-boundary",
    "codex/devdocs-wave15-source-time-production-readiness",
    "codex/devdocs-wave15-openclaw-runtime-handoff",
    "codex/devdocs-wave15-llm-crawler-replay-manifest",
    "codex/devdocs-wave15-symbolic-live-quality-threshold",
    "codex/devdocs-wave15-structured-sql-helper-migration",
    "codex/devdocs-wave15-consumer-sql-predicate-facade",
    "codex/devdocs-wave15-graph-editing-audit-durability",
    "codex/devdocs-wave15-typed-writing-live-boundary",
]
...
def main() -> int:
    ...
    if current_branch not in allowed_branches:
        problems.append(f"current branch is {current_branch!r}, expected a Wave15 branch")
    ...
    if problems:
        for problem in problems:
            print(f"FAIL wave15_current_dev_plan: {problem}", file=sys.stderr)
        return 1

    print(
        "OK wave15_current_dev_plan=passed "

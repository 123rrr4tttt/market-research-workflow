#!/usr/bin/env python3
"""Validate the Wave13 CURRENT_DEV worktree plan.

The gate verifies that the supervisor plan mentions every Wave13 branch and
...
PLAN_PATH = Path(
    ...
    "wave13-worktree-plan-2026-05-22.md"
)
INTEGRATION_BRANCH = "codex/devdocs-wave13-integration-2026-05-22"
SUPERVISOR_BRANCH = "codex/devdocs-supervisor-seed"

EXPECTED_BRANCHES = [
    "codex/devdocs-wave13-llm-crawler-high-js-replay",
    "codex/devdocs-wave13-symbolic-search-provider-quality",
    "codex/devdocs-wave13-structured-data-api-migration",
    "codex/devdocs-wave13-consumer-dashboard-extraction",
    "codex/devdocs-wave13-agentcore-live-provider-readiness",
    "codex/devdocs-wave13-long-cycle-scheduler-readiness",
    "codex/devdocs-wave13-crawler-public-replay-gate",
    "codex/devdocs-wave13-abstract-folderization-closure",
    "codex/devdocs-wave13-merged-overview-drift-gate",
]
...
def main() -> int:
    ...
    if current_branch not in allowed_branches:
        problems.append(f"current branch is {current_branch!r}, expected a Wave13 branch")
    ...
    if problems:
        for problem in problems:
            print(f"FAIL wave13_current_dev_plan: {problem}", file=sys.stderr)
        return 1

    print(
        "OK wave13_current_dev_plan=passed "

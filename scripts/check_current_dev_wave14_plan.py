#!/usr/bin/env python3
"""Validate the Wave14 CURRENT_DEV worktree plan."""
...
PLAN_PATH = Path(
    ...
    "wave14-worktree-plan-2026-05-22.md"
)
INTEGRATION_BRANCH = "codex/devdocs-wave14-integration-2026-05-22"
SUPERVISOR_BRANCH = "codex/devdocs-supervisor-seed"

EXPECTED_BRANCHES = [
    "codex/devdocs-wave14-vectorization-provider-capability",
    "codex/devdocs-wave14-graph-visual-data-smoke",
    "codex/devdocs-wave14-graph-node-live-db-readiness",
    "codex/devdocs-wave14-ingest-canary-metrics",
    "codex/devdocs-wave14-time-density-doc-refresh",
    "codex/devdocs-wave14-source-library-taxonomy-review",
    "codex/devdocs-wave14-frontend-migration-boundary",
    "codex/devdocs-wave14-abstract-content-gaps",
    "codex/devdocs-wave14-agentcore-tool-calling-quality",
]
...
def main() -> int:
    ...
    if current_branch not in allowed_branches:
        problems.append(f"current branch is {current_branch!r}, expected a Wave14 branch")
    ...
    if problems:
        for problem in problems:
            print(f"FAIL wave14_current_dev_plan: {problem}", file=sys.stderr)
        return 1

    print(
        "OK wave14_current_dev_plan=passed "

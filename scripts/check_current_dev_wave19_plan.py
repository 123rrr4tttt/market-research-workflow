#!/usr/bin/env python3
"""Validate the Wave19 CURRENT_DEV worktree plan."""
...
PLAN_PATH = Path(
    ...
    "wave19-worktree-plan-2026-05-22.md"
)
INTEGRATION_BRANCH = "codex/devdocs-wave19-integration-2026-05-22"
SUPERVISOR_BRANCH = "codex/devdocs-supervisor-seed"

EXPECTED_BRANCHES = [
    "codex/devdocs-wave19-vectorization-provider-manifest",
    "codex/devdocs-wave19-open-search-health-schema",
    "codex/devdocs-wave19-graph-rollout-readback",
    "codex/devdocs-wave19-ingest-canary-24h-metrics",
    "codex/devdocs-wave19-crawler-public-replay-shards",
    "codex/devdocs-wave19-agentcore-provider-redaction",
    "codex/devdocs-wave19-source-library-review-batch3",
    "codex/devdocs-wave19-frontend-i18n-dashboard-slice",
    "codex/devdocs-wave19-docs-root-content-move-batch4",
    "codex/devdocs-wave19-typed-writing-ui-boundary",
]
...
def main() -> int:
    ...
    if current_branch not in allowed_branches:
        problems.append(f"current branch is {current_branch!r}, expected a Wave19 branch")
    ...
    if problems:
        for problem in problems:
            print(f"FAIL wave19_current_dev_plan: {problem}", file=sys.stderr)
        return 1

    print(
        "OK wave19_current_dev_plan=passed "

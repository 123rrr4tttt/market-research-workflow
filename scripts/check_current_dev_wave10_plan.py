#!/usr/bin/env python3
"""Validate the Wave10 CURRENT_DEV worktree plan.

The gate verifies that the supervisor plan mentions every Wave10 branch and
...
PLAN_PATH = Path(
    ...
    "wave10-worktree-plan-2026-05-22.md"
)
INTEGRATION_BRANCH = "codex/devdocs-wave10-integration-2026-05-22"
SUPERVISOR_BRANCH = "codex/devdocs-supervisor-seed"

EXPECTED_BRANCHES = [
    "codex/devdocs-wave10-graph-frontend-visual",
    "codex/devdocs-wave10-graph-node-db-rollout",
    "codex/devdocs-wave10-time-semantics-ope",
    "codex/devdocs-wave10-llm-crawler-tristate",
    "codex/devdocs-wave10-source-library-governance",
    "codex/devdocs-wave10-vectorization-quality",
    "codex/devdocs-wave10-writing-typed-knowledge",
    "codex/devdocs-wave10-docs-root-content-shim",
    "codex/devdocs-wave10-parallel-runtime-contract",
]
...
def main() -> int:
    ...
    if current_branch not in allowed_branches:
        problems.append(f"current branch is {current_branch!r}, expected a Wave10 branch")
    ...
    if problems:
        for problem in problems:
            print(f"FAIL wave10_current_dev_plan: {problem}", file=sys.stderr)
        return 1

    print(
        "OK wave10_current_dev_plan=passed "

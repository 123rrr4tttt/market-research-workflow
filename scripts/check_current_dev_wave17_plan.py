#!/usr/bin/env python3
"""Validate the Wave17 CURRENT_DEV worktree plan."""
...
PLAN_PATH = Path(
    ...
    "wave17-worktree-plan-2026-05-22.md"
)
INTEGRATION_BRANCH = "codex/devdocs-wave17-integration-2026-05-22"
SUPERVISOR_BRANCH = "codex/devdocs-supervisor-seed"

EXPECTED_BRANCHES = [
    "codex/devdocs-wave17-source-time-production-sample-gate",
    "codex/devdocs-wave17-ingest-canary-metrics-readback",
    "codex/devdocs-wave17-graph-visual-runtime-pixel-gate",
    "codex/devdocs-wave17-graph-node-rollout-readback",
    "codex/devdocs-wave17-typed-knowledge-durable-readback",
    "codex/devdocs-wave17-writing-persisted-card-ui-readback",
    "codex/devdocs-wave17-frontend-page-i18n-slice",
    "codex/devdocs-wave17-structured-consumer-query-boundary",
    "codex/devdocs-wave17-docs-root-content-move-batch2",
]
...
def main() -> int:
    ...
    if current_branch not in allowed_branches:
        problems.append(f"current branch is {current_branch!r}, expected a Wave17 branch")
    ...
    if problems:
        for problem in problems:
            print(f"FAIL wave17_current_dev_plan: {problem}", file=sys.stderr)
        return 1

    print(
        "OK wave17_current_dev_plan=passed "
